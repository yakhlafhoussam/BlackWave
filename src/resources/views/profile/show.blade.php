        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div class="flex items-center gap-4">
                <div class="text-center">
                    <div class="text-4xl font-bold text-white">{{ number_format($user->avg_rating ?? 0, 1) }}</div>
                    <div class="text-xs text-gray-500">Average Rating</div>
                </div>
                <div>
                    <div class="flex items-center gap-1 mb-1">
                        @for($i = 1; $i <= 5; $i++)
                            <svg class="h-5 w-5 {{ $i <= ($user->avg_rating ?? 0) ? 'text-yellow-400' : 'text-gray-600' }}" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="rounded-2xl border border-white/10 bg-black/50 backdrop-blur-sm overflow-hidden hover:border-green-500/50 transition-all duration-300 hover:scale-[1.02]">
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex items-center justify-between text-xs">
                                ...
                                <a href="{{ route('marketplace.show', $product) }}" class="text-blue-400 hover:text-blue-300 font-medium text-sm">View →</a>
                            </div>
                        </div>
                    </div>
                @endforeach
