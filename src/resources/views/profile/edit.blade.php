...
<div class="max-w-4xl mx-auto px-4 md:px-6 lg:px-8 py-6 md:py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            ...
            {{-- Danger Zone --}}
            <div class="mt-6 rounded-2xl border border-red-500/30 bg-red-500/5 backdrop-blur-sm p-6">
                <div class="flex items-center justify-between flex-wrap gap-4">
                    <div>
                        <h3 class="text-lg font-semibold text-red-400 mb-1">Danger Zone</h3>
                        <p class="text-sm text-gray-500">Once you delete your account, there is no going back.</p>
                    </div>
                    <button 
                        type="button"
                        x-data=""
                        @click="$dispatch('open-delete-modal')"
                        class="px-4 py-2 bg-red-600/20 border border-red-500/50 text-red-400 rounded-xl text-sm font-medium hover:bg-red-600/30 transition-all"
                    >
                        Delete Account
                    </button>
                </div>
            ...
            <form method="POST" action="#">
                ...
                <div class="mb-4">
                    ...
                    <input 
                        ...
                        class="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-2 text-white placeholder-gray-500 focus:border-red-500 focus:outline-none focus:ring-2 focus:ring-red-500/30"
                    >
                </div>
                <div class="flex gap-3">
                    <button type="button" @click="showDeleteModal = false" class="flex-1 px-4 py-2 bg-white/10 text-white rounded-lg hover:bg-white/20 transition-colors">
                        Cancel
                    </button>
                    <button type="submit" class="flex-1 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-500 transition-colors">
