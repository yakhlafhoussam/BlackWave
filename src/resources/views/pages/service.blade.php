            ...
            <div
                ...
                <div class="relative h-48 overflow-hidden bg-gradient-to-br from-blue-600/20 to-purple-600/20">
                    ...
                    <div
                        ...
                        <i class="fa-brands fa-octopus-deploy text-lg text-blue-600"></i>
                        BlackWave
                    </div>
            ...
            @if (isset($service) && $service->count() > 0)
                @foreach ($service as $dbService)
                    <div
                        ...
                        <div class="relative h-48 overflow-hidden bg-gradient-to-br from-blue-600/20 to-purple-600/20">
                            @if ($dbService->service_image)
                                <img src="{{ asset('storage/' . $dbService->service_image) }}" alt="{{ $dbService->title }}"
                                    class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                            @else
                            ...
                            @if ($dbService->category)
                                <div
                                    class="absolute top-3 left-3 bg-black/60 backdrop-blur-sm text-white px-2.5 py-1 rounded-lg text-xs flex justify-center items-center gap-1.5">
                                    <i class="{{ $dbService->category->icon }} text-lg"
                                        style="color: {{ $dbService->category->color ?? '#3b82f6' }}"></i>
                        ...
                        <div class="p-4">
                            ...
                            <a href="{{ route('show.service', $dbService) }}"
